...
namespace TGA
{
	namespace FBX
	{
		...
		public:
			/**
			* Temporary setting since some assets have been exported to compesante for incorrect skeleton scale. Will always be true in the future.
			*/
			static void SetShouldBakeSkeletonRootTransforms(bool shouldBake);
