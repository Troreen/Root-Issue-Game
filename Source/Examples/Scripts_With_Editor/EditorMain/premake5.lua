...
-------------------------------------------------------------
local projectname = "ScriptEditorMain"
project (projectname)
	location (dirs.projectfiles)
	dependson { "External", "Engine", "ScriptGame", "TGEditor" }
	...
	links {"External", "Engine", "ScriptGame", "TGEditor" }
	includedirs { 
		dirs.external, 
	...
	defines
	{
		"TGE_PROJECT_SETTINGS_FILE=\"ScriptGame.json\""
	}
