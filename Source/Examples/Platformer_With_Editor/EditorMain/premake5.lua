...
-------------------------------------------------------------
local projectname = "PlatformerEditorMain"
project (projectname)
	location (dirs.projectfiles)
	dependson { "External", "Engine", "PlatformerGame", "TGEditor" }
	...
	links {"External", "Engine", "PlatformerGame", "TGEditor" }
	includedirs { 
		dirs.external, 
	...
	defines
	{
		"TGE_PROJECT_SETTINGS_FILE=\"PlatformerGame.json\""
	}
